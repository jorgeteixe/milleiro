...
import es.jorgeteixeira.milleiro.lists.IngredentesAdapter;
import es.jorgeteixeira.milleiro.model.Produto;

public class IngredentesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingredentes);
        ...
        listView.setAdapter(new IngredentesAdapter(this, produto.getIngredentes()));
